    ...
    public partial class App : Application
    {
        ...
        private void AppConfig_ThemeChanged(object sender, EventArgs e)
        {
            if (AppConfig.LoadInstance().Theme != null)
            {
                ...
                var dictionary = new ResourceDictionary { Source = new Uri($"/Resources/{AppConfig.Theme}.xaml", UriKind.RelativeOrAbsolute) };
        ...
        private void AppConfig_LanguageChanged(object sender, EventArgs e)
        {
            if (AppConfig.LoadInstance().Language != null)
            {
                ...
                var dictionary = new ResourceDictionary { Source = new Uri($"/Resources/{AppConfig.Language}.xaml", UriKind.RelativeOrAbsolute) };
